...
const Header = ({colorMode, featureIsVisible, svgInView, svgRef}) => {
  ...
  return (
    <header id='home' className={`flex flex-col items-center justify-between w-full relative min-h-[calc(100vh-6rem)]  md:py-12 py-24 md:py-12 mb-12 px-10 md:px-24`}>
      <div className='flex flex-col items-start md:w-7/12 sm:py-24  '>
        <motion.svg width="250" height="150" className='mx-auto' viewBox="0 0 250 150" fill="none" xmlns="http://www.w3.org/2000/svg"  ref={svgRef}
        initial="hidden"
        whileInView="visible"
        variants={{
          hidden: { opacity: 0},
         ...
         transition={{
          duration: 1
              ...
              <g clip-path="url(#clip0_626_6998)">
                <motion.path d="M125 122.1C129.142 122.1 132.5 118.742 132.5 114.6C132.5 110.458 129.142 107.1 125 107.1C120.858 107.1 117.5 110.458 117.5 114.6C117.5 118.742 120.858 122.1 125 122.1Z" stroke={colorMode === "dark" ? "white" : "black"} fill={colorMode === "dark" ? "white" : "black"} initial={{ pathLength: 0 }} animate={{ pathLength: svgInView ? 1 : 0 }} transition={{ duration: 2 }}/>
                  <motion.path d="M84.9023 93.5C88.8023 90.9 93.1023 87.9 98.0023 87.9C102.102 88 105.802 90.4 107.802 93.7C111.502 99.6 108.902 108.8 101.602 111C97.4023 112.3 92.5023 110.5 90.5023 106.8" stroke={colorMode === "dark" ? "white" : "black"} strokeWidth={8} stroke-miterlimit="10" stroke-linecap="round" initial={{ pathLength: 0 }} animate={{ pathLength: svgInView ? 1 : 0 }} transition={{ duration: 2 }}/>
                  <motion.path d="M85.1007 93.4C74.8007 100.5 63.2007 108.8 50.4007 102.1C40.3007 96.9 34.0007 84.5 37.0007 73.3C39.9007 62.4 50.7007 54.1 62.1007 57.2C71.8007 59.8 79.7007 70.7 73.8007 80.2C69.1007 88 56.4007 91 51.7007 81.5" stroke={colorMode === "dark" ? "white" : "black"} strokeWidth={8} stroke-miterlimit="10" stroke-linecap="round" initial={{ pathLength: 0 }} animate={{ pathLength: svgInView ? 1 : 0 }} transition={{ duration: 2 }}/>
                  ...
                  <motion.path d="M165.1 93.5C161.2 90.9 156.9 87.9 152 87.9C147.9 88 144.2 90.4 142.2 93.7C138.5 99.6 141.1 108.8 148.4 111C152.6 112.3 157.5 110.5 159.5 106.8" stroke={colorMode === "dark" ? "white" : "black"} strokeWidth={8} stroke-miterlimit="10" stroke-linecap="round" initial={{ pathLength: 0 }} animate={{ pathLength: svgInView ? 1 : 0 }} transition={{ duration: 2 }}/>
                  <motion.path d="M164.898 93.4C175.198 100.5 186.798 108.8 199.598 102.1C209.698 96.8 215.998 84.5 212.998 73.3C210.098 62.4 199.298 54.1 187.898 57.2C178.198 59.8 170.298 70.7 176.198 80.2C180.998 88 193.698 90.9 198.398 81.4" stroke={colorMode === "dark" ? "white" : "black"} strokeWidth={8} stroke-miterlimit="10" stroke-linecap="round" initial={{ pathLength: 0 }} animate={{ pathLength: svgInView ? 1 : 0 }} transition={{ duration: 2 }}/>
                  ...
                  <motion.path d="M125.003 43.9C121.103 34.3 113.203 27.7 102.503 27.9C92.1027 28.1 81.9027 34.5 78.8027 44.7C75.9027 53.9 79.0027 65 88.0027 69.6C95.4027 73.4 106.703 72.4 110.703 64.2C114.903 55.4 108.103 40.8 97.0027 44.7" stroke={colorMode === "dark" ? "white" : "black"} strokeWidth={8} stroke-miterlimit="10" stroke-linecap="round" initial={{ pathLength: 0 }} animate={{ pathLength: svgInView ? 1 : 0 }} transition={{ duration: 2 }}/>
                  ...
                  <motion.path d="M125.004 43.9C128.904 34.3 136.804 27.7 147.504 27.9C157.904 28.1 168.104 34.5 171.204 44.7C174.104 53.9 171.004 65 162.004 69.6C154.604 73.4 143.304 72.4 139.304 64.2C135.104 55.4 141.904 40.8 153.004 44.7" stroke={colorMode === "dark" ? "white" : "black"} strokeWidth={8} stroke-miterlimit="10" stroke-linecap="round" initial={{ pathLength: 0 }} animate={{ pathLength: svgInView ? 1 : 0 }} transition={{ duration: 2 }}/>
