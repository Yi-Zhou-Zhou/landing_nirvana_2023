...
const PaymentNavbar = ( { colorMode, setColorMode, scrollPosition, setLang, lang, svgInView } ) =>
{
    ...
    return (
        <nav className="absolute flex glass-navbar border-none duration-700 dark:text-white justify-between items-center h-20 w-full px-4 text-black top-0 shadow-md -2 md:px-20  align-middle  z-50">
            <a href="/" aria-label='home' className='h-3/6 md:h-4/6 flex items-center'>
            ...
            <div className='hidden md:flex gap-8 items-center'>
                { themeButton }
                <div className='flex gap-1 items-center cursor-pointer dark:text-white text-black' onClick={ () => lang === "es" ? setLang( "en" ) : setLang( "es" ) }>
                    <Globe size={ 28 } />
