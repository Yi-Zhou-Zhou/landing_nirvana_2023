...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
          <p className='text-4xl w-fit text-white'>Comienza tu nueva vida con</p>
      ...
      <motion.form class="grow flex flex-col gap-16">
        ...
        >
          <div class="relative z-0 w-5/12">
            ...
            <label for="floating_standard" class="absolute text-sm text-gray-500 dark:text-white  duration-300 transform -translate-y-6 scale-75 top-0 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nombre</label>
          </div>
          <div class="relative z-0 w-5/12">
        ...
        transition={{
          ...
          <div class="relative z-0 w-5/12">
            ...
            <label for="floating_standard" class="absolute text-sm text-gray-500 dark:text-white duration-300 transform -translate-y-6 scale-75 top-0 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Teléfono (Opcional)</label>
          </div>
          <div class="relative z-0 w-5/12">
